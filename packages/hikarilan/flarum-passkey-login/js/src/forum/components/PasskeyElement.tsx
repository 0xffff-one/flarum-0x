...
export default class PasskeyElement extends Component<IAttrs> {
  view(vnode: Mithril.Vnode<IAttrs>): Mithril.Children {
    ...
    return (
      <div className="PasskeysList-item">
        <div className="PasskeysList-item-icon">{icon('fas fa-key')}</div>
        <div className="PasskeysList-item-info">
          ...
          <div className="PasskeysList-item-createdAt">
            <LabelValue label={app.translator.trans('core.forum.security.created')} value={humanTime(this.attrs.passkey.createdAt())} />
          </div>
          <div className="PasskeysList-item-lastSeenAt">
            <LabelValue label={app.translator.trans('core.forum.security.last_activity')} value={humanTime(this.attrs.passkey.lastSeenAt())} />
          </div>
        </div>
